...
export function IconSprite() {
  return (
    <svg width="0" height="0" style={{ position: 'absolute' }} aria-hidden="true">
      ...
      <symbol id="sh-chevron-abajo" viewBox="0 0 24 24">
      ...
      <symbol id="sh-plegar" viewBox="0 0 24 24">
...
export function Icon({ name, size = 19, className, style, title }) {
  if (import.meta.env?.DEV && !ICONS.includes(name)) {
    console.warn(`Icon: «${name}» no está en el registro. Añádelo a core-ui/icons.jsx o usa uno de: ${ICONS.join(', ')}`);
  }
  ...
  return (
    ...
    >
      ...
      {/* Pictogramas de área y de flujo documental, traídos del prototipo de
          Reporte Estadístico. */}
      <symbol id="sh-pastilla" viewBox="0 0 24 24">
      ...
      <symbol id="sh-gota" viewBox="0 0 24 24">
      ...
      <symbol id="sh-bisturi" viewBox="0 0 24 24">
      ...
      <symbol id="sh-lavadora" viewBox="0 0 24 24">
      ...
      <symbol id="sh-cubiertos" viewBox="0 0 24 24">
      ...
      <symbol id="sh-radiografia" viewBox="0 0 24 24">
      ...
      <symbol id="sh-llave" viewBox="0 0 24 24">
      ...
      <symbol id="sh-bebe" viewBox="0 0 24 24">
      ...
      <symbol id="sh-enviar" viewBox="0 0 24 24">
      ...
      <symbol id="sh-remitir" viewBox="0 0 24 24">
      ...
      <symbol id="sh-sello" viewBox="0 0 24 24">
      ...
      <symbol id="sh-semaforo" viewBox="0 0 24 24">
      ...
      <symbol id="sh-boletin" viewBox="0 0 24 24">
      ...
      <symbol id="sh-bandeja" viewBox="0 0 24 24">
      ...
      <symbol id="sh-lapiz" viewBox="0 0 24 24">
      ...
      <symbol id="sh-tijeras" viewBox="0 0 24 24">
      ...
      <symbol id="sh-caja" viewBox="0 0 24 24">
